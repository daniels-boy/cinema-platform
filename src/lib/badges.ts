...
export const ALL_BADGES: Badge[] = [
  // ── Gênero: Terror ──
  {
    ...
    hint: "Avalie 50 filmes de Terror",
    threshold: 50,
    category: "genre",
  },
  // ── Gênero: Romance ──
  {
    ...
    hint: "Avalie 50 filmes de Romance",
    threshold: 50,
    category: "genre",
  },
  // ── Gênero: Ação ──
  ...
  // ── Gênero: Comédia ──
  {
    ...
    hint: "Avalie 50 filmes de Comédia",
    threshold: 50,
    category: "genre",
  },
  // ── Gênero: Sci-Fi ──
  {
    ...
    hint: "Avalie 50 filmes de Ficção Científica",
    threshold: 50,
    category: "genre",
  },
  // ── Gênero: Animação ──
  {
    ...
    hint: "Avalie 50 filmes de Animação",
    threshold: 50,
    category: "genre",
  },
  // ── Diretor: Tarantino ──
  {
    ...
    hint: "Avalie 15 filmes de Quentin Tarantino",
    threshold: 15,
    category: "director",
  },
  // ── Diretor: Nolan ──
  {
    ...
    hint: "Avalie 15 filmes de Christopher Nolan",
    threshold: 15,
    category: "director",
  },
  // ── Era: Anos 80 ──
  {
    ...
    hint: "Avalie 50 filmes dos anos 80 (1980–1989)",
    threshold: 50,
    category: "era",
  },
  // ── Era: Clássicos ──
  {
    ...
    hint: "Avalie 50 filmes de antes de 1980",
    threshold: 50,
    category: "era",
  },
